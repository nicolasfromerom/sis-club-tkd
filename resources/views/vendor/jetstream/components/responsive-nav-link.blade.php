...
$classes = ($active ?? false)
            ? 'block pl-3 pr-4 py-2 border-l-4 border-red-400 text-base font-medium text-gray-100 bg-red-400 focus:outline-none focus:text-indigo-800 focus:bg-indigo-100 focus:border-indigo-700 transition'
